...
extern const u8 gText_SavingFaints[];
extern const u8 gText_KOLeader[];
...
extern const u8 gText_FlygonNervous[];
...
extern const u8 gText_Finished[];
...
extern const u8 gText_NoProgressToSave[];
