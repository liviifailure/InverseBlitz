...
#define OW_SHOW_ITEM_DESCRIPTIONS       2    // If enabled, item descriptions/images will be shown when finding items.
...
#define OW_PC_HEAL                  GEN_8 // In Gen8+, Pokémon are not healed when deposited in the PC.
