...
enum StringID
{
    ...
    STRINGID_RANSACKEDBAGFORORANBERRY,
    STRINGID_THUNDERSTORMSUBSIDED,
    STRINGID_THUNDERSTORMBREWED,
    STRINGID_THUNDERSTORMRAGES,
    STRINGID_COUNT
};
...
enum WeatherEndStringID
{
    ...
    B_MSG_WEATHER_END_THUNDERSTORM,
...
enum WeatherTurnStringID
{
    ...
    B_MSG_WEATHER_TURN_THUNDERSTORM,
};
