...
#define VAR_PLAYER_PALETTE_CHOICE                        0x4091 // Stores player's palette selection (0=Default, 1=Blue, etc)
...
#define VAR_FORCEANIM	                     0x40A8 // Forces battle scenes on
...
#define VAR_POWER_TM_CLERK                               0x40BB
...
#define VAR_SOOTOPOLIS_GYM_LAYOUT                        0x40DB
...
#define VAR_DAYCARE_BADGE_TRACKER                        0x40F7 // Number of gyms beaten when pokemon was dropped off
#define VAR_SLATEPORT_RENTAL_STATE                       0x40F8
#define VAR_RENTAL_MON_OFFER                             0x40F9 
