...
const u8 gText_RansackedBagForOranBerry[] = _("{B_ATK_NAME_WITH_PREFIX} ransacked the bag for\nan Oran Berry!");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNFRISKEDITEM]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} stole the foe's {B_LAST_ITEM}!"),
    ...
    [STRINGID_COMMANDERACTIVATES]                   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} was swallowed and became a commander!"),
    ...
    [STRINGID_RANSACKEDBAGFORORANBERRY]             = gText_RansackedBagForOranBerry,
    ...
    [STRINGID_THUNDERSTORMSUBSIDED]                 = COMPOUND_STRING("The thunderstorm subsided."),
};
...
const u16 gWeatherEndsStringIds[B_MSG_WEATHER_END_COUNT] =
{
    ...
    [B_MSG_WEATHER_END_THUNDERSTORM] = STRINGID_THUNDERSTORMSUBSIDED,
};
...
const u16 gWeatherTurnStringIds[] =
{
    ...
    [B_MSG_WEATHER_TURN_THUNDERSTORM] = STRINGID_THUNDERSTORMRAGES,
};
...
const u16 gWeatherStartsStringIds[] =
{
    ...
    [WEATHER_RAIN_THUNDERSTORM]  = STRINGID_THUNDERSTORMBREWED,
