...
const u8 gText_LeagueChamp[] = _("BLITZ v8.8 CHAMPION!\nCONGRATULATIONS!");
const u8 gText_LeagueChampNTS[] = _("BLITZ v8.8  CHAMPION!\nCONGRATULATIONS!");
const u8 gText_LeagueChampFB[] = _(" BLITZ v8.8 CHAMPION!\nCONGRATULATIONS!");
...
const u8 gText_GrandPrixMessage[] = _("You stare at the wall with intense\nanticipation.");
