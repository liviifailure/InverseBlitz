...
const u8 gText_LeagueChamp[] = _("BLITZ v8.5 CHAMPION!\nCONGRATULATIONS!");
const u8 gText_LeagueChampNTS[] = _("BLITZ v8.5  CHAMPION!\nCONGRATULATIONS!");
const u8 gText_LeagueChampFB[] = _(" BLITZ v8.5 CHAMPION!\nCONGRATULATIONS!");
...
const u8 gText_GrandPrixMessage[] = _("Wow, this sure is a nice-looking\nwall!");
