...
const u8 gText_LeagueChamp[] = _("BLITZ v8.63 CHAMPION!\nCONGRATULATIONS!");
const u8 gText_LeagueChampNTS[] = _("BLITZ v8.63  CHAMPION!\nCONGRATULATIONS!");
const u8 gText_LeagueChampFB[] = _(" BLITZ v8.63 CHAMPION!\nCONGRATULATIONS!");
...
const u8 gText_GrandPrixMessage[] = _("The wall is all full of dents.\nI guess there was too much bangers.");
