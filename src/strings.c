...
const u8 gText_WelcomeToHOF[] = _("Welcome to the HALL OF FAME!\n          Emerald Blitz v9.0beta");
const u8 gText_WelcomeToNTS[] = _("Welcome to the HALL 0F FAME!\n         Emerald Blitz v9.0beta");
const u8 gText_WelcomeToFB[] =  _("Welcome to the HALL 0F FAME!\n           Emerald Blitz v9.0beta");
...
const u8 gText_LeagueChamp[] = _("BLITZ v9.0beta CHAMPION!\nCONGRATULATIONS!");
const u8 gText_LeagueChampNTS[] = _("BLITZ v9.0beta  CHAMPION!\nCONGRATULATIONS!");
const u8 gText_LeagueChampFB[] = _(" BLITZ v9.0beta CHAMPION!\nCONGRATULATIONS!");
...
const u8 gMenuText_GiveAll[] = _("GIVE ALL");
const u8 gMenuText_Confirm[] = _("CONFIRM");
const u8 gText_Cancel[] = _("CANCEL");
const u8 gText_GiveAll[] = _("GIVE ALL");
const u8 gText_NotEnoughBerries[] = _("Not enough berries.{PAUSE_UNTIL_PRESS}");
const u8 gText_BerriesGivenOut[] = _("The {STR_VAR_1} was given out.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Foe[] = _("ENEMY");
const u8 gText_BattleMenuTrainer[] = _("{PALETTE 5}FIGHT         {PALETTE 5}BAG\n{PALETTE 5}POKéMON     {PALETTE 5}ENEMY");
...
const u8 gText_NoPokemonToGiveItem[] = _("There is no POKéMON\nto give that to.{PAUSE_UNTIL_PRESS}");
const u8 gText_GaveToAllPkmn[] = _("Gave the {STR_VAR_1} to\nyour POKéMON.{PAUSE_UNTIL_PRESS}");
...
// Set to 0 since items no longer sell for money
...
const u8 gText_PkmnNeedsToReplaceMove[] = _("Should a move be deleted and\nreplaced with {STR_VAR_2}?");
...
const u8 gText_TotalTurns[] = _("TOTAL TURNS");
const u8 gText_KOCount[] = _("KO COUNT");
...
const u8 gText_EggFromHotSprings[] = _("A POKéMON EGG. What\nmight it contain?");
...
const u8 gText_PlayersPC[] = _("SANDBOX MODE");
...
const u8 gText_NathansLair[] = _("NATHAN'S LAIR");
...
const u8 gText_SelectTheAnswerToTheQuiz[] = _("select your answer!");
...
const u8 gText_TheQuizAnswerIs[] = _("The answer is?");
...
const u8 gText_SavingFaints[] = _("DEATHS");
...
const u8 gText_NoProgressToSave[] = _("If only you had any progress to save…{PAUSE_UNTIL_PRESS}");
...
const u8 gText_SavingBadges[] = _("GYMS");
