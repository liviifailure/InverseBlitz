...
static const struct FormChange sBurmyFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_BURMY_PLANT, ITEM_BURMY_BINDER, 0},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_BURMY_SANDY, ITEM_BURMY_BINDER, 1},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_BURMY_TRASH, ITEM_BURMY_BINDER, 2},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sWormadamFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_WORMADAM_PLANT, ITEM_BURMY_BINDER, 0},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_WORMADAM_SANDY, ITEM_BURMY_BINDER, 1},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_WORMADAM_TRASH, ITEM_BURMY_BINDER, 2},
    {FORM_CHANGE_TERMINATOR},
};
