...
#define BLASTOISE_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 105 : 85)
    ...
    [SPECIES_PICHU] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 10, SPECIES_PIKACHU}),
    },
...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_SANDSHREW_ALOLA] =
    {
        ...
        .formSpeciesIdTable = sSandshrewFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_SANDSLASH_ALOLA}),
    },
    ...
    [SPECIES_CLEFFA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 10, SPECIES_CLEFAIRY}),
    },
#endif //P_GEN_2_CROSS_EVOS
    ...
    [SPECIES_IGGLYBUFF] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 10, SPECIES_JIGGLYPUFF}),
    },
#endif //P_GEN_2_CROSS_EVOS
    ...
    [SPECIES_SLOWPOKE_GALAR] =
    {
        ...
        .formSpeciesIdTable = sSlowpokeFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_SLOWBRO_GALAR},
                                {EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_SLOWKING_GALAR}),
    },
...
#define MAGNEMITE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_2 ? TYPE_STEEL : TYPE_ELECTRIC)
    ...
    [SPECIES_FARFETCHD_GALAR] =
    {
        ...
        .formSpeciesIdTable = sFarfetchdFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_SIRFETCHD}),
    },
...
#define GENGAR_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 75 : 130)
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_WEEZING, CONDITIONS({IF_TIME, TIME_DAY})},
                                {EVO_LEVEL, 35, SPECIES_WEEZING_GALAR, CONDITIONS({IF_TIME, TIME_NIGHT})}),
    },
    ...
    [SPECIES_RHYDON] =
    {
        ...
        .evolutions = EVOLUTION({EVO_TRADE, 0, SPECIES_RHYPERIOR, CONDITIONS({IF_HOLD_ITEM, ITEM_PROTECTOR})},
                                {EVO_ITEM, ITEM_LINKING_CORD, SPECIES_RHYPERIOR}),
    #endif
    },
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_TRADE, ITEM_METAL_COAT, SPECIES_SCIZOR},
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_TRADE, 0, SPECIES_ELECTIVIRE, CONDITIONS({IF_HOLD_ITEM, ITEM_LINKING_CORD})},
                                {EVO_ITEM, ITEM_LINKING_CORD, SPECIES_ELECTIVIRE}),
    #endif
    },
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_TRADE, 0, SPECIES_MAGMORTAR, CONDITIONS({IF_HOLD_ITEM, ITEM_LINKING_CORD})},
                                {EVO_ITEM, ITEM_LINKING_CORD, SPECIES_MAGMORTAR}),
    #endif
    },
...
#define EEVEE_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 45 : 65)
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_TRADE, 0, SPECIES_PORYGON_Z, CONDITIONS({IF_HOLD_ITEM, ITEM_LINKING_CORD})},
                                {EVO_ITEM, ITEM_LINKING_CORD, SPECIES_PORYGON_Z}),
    #endif
    },
