...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_QUILAVA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_TYPHLOSION, CONDITIONS({IF_TIME, TIME_DAY})},
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_BONSLY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_SUDOWOODO}),
    },
#endif //P_GEN_4_CROSS_EVOS
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_WEAVILE, CONDITIONS({IF_TIME, TIME_NIGHT}, {IF_HOLD_ITEM, ITEM_RAZOR_CLAW})},
                                {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_WEAVILE}),
    },
    ...
    [SPECIES_MANTYKE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_MANTINE}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    #if P_GEN_8_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_WYRDEER}),
    #endif
    },
