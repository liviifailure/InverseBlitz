...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_DEWOTT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_SAMUROTT, CONDITIONS({IF_TIME, TIME_DAY})},
    ...
    [SPECIES_WOOBAT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_SWOOBAT}),
    },
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_PETILIL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT, CONDITIONS({IF_TIME, TIME_DAY})},
    ...
    [SPECIES_SHELMET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_ACCELGOR}),
    },
    ...
    [SPECIES_PAWNIARD] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_DUSK_STONE, SPECIES_BISHARP}),
    },
    ...
    [SPECIES_BISHARP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 48, SPECIES_KINGAMBIT}),
    #endif
    },
    ...
    [SPECIES_RUFFLET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 54, SPECIES_BRAVIARY, CONDITIONS({IF_TIME, TIME_DAY})},
                                {EVO_LEVEL, 54, SPECIES_BRAVIARY_HISUI, CONDITIONS({IF_TIME, TIME_NIGHT})}),
    },
