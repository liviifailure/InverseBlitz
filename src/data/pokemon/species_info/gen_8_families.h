...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_CLOBBOPUS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_WATER_STONE, SPECIES_GRAPPLOCT}),
    },
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                      \
    ...
    [SPECIES_KUBFU] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_URSHIFU_RAPID_STRIKE, CONDITIONS({IF_IN_MAP, MAP_METEOR_FALLS_B1F_2R})},
                                {EVO_LEVEL, 0, SPECIES_URSHIFU_SINGLE_STRIKE, CONDITIONS({IF_IN_MAP, MAP_SKY_PILLAR_TOP})}),
    },
