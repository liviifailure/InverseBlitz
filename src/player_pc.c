...
static const u16 sNewGamePCItems[][2] =
{
    ...
    { ITEM_WHIPPED_DREAM, 10 },
    { ITEM_LINKING_CORD, 10 },
    { ITEM_SOOTHE_BELL, 10 },
    { ITEM_FIRE_STONE, 10 },
    { ITEM_WATER_STONE, 10 },
    { ITEM_THUNDER_STONE, 10 },
    { ITEM_LEAF_STONE, 10 },
    { ITEM_ICE_STONE, 10 },
    { ITEM_MOON_STONE, 10 },
    { ITEM_SUN_STONE, 10 },
    ...
    { ITEM_SERIOUS_MINT, 50 },
    { ITEM_LONELY_MINT, 10 },
    { ITEM_ADAMANT_MINT, 10 },
    { ITEM_NAUGHTY_MINT, 10 },
    { ITEM_BRAVE_MINT, 10 },
    { ITEM_BOLD_MINT, 10 },
    { ITEM_IMPISH_MINT, 10 },
    { ITEM_LAX_MINT, 10 },
    { ITEM_RELAXED_MINT, 10 },
    { ITEM_MODEST_MINT, 10 },
    { ITEM_MILD_MINT, 10 },
    { ITEM_RASH_MINT, 10 },
    { ITEM_QUIET_MINT, 10 },
